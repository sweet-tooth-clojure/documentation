...
enough, this kind of work is /hard/, and if you had to do it every time you
wanted to make an application it would be frustrating an exhausting. Actually,
let me rephrase that: I /have/ had to do this work, and it /is/ frustrating and
...
popular and powerful is [Devise](https://github.com/plataformatec/devise), which
...
not frameworks" approach, I /loved/ it. A framework felt unnecessary because all
...
so moved, please do join! I /love/ getting to interact with people in that
